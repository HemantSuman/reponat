...
var extraVar = [];
var viewDirectory = 'email_templates';
var modelName = 'EmailTemplate';
var titleName = 'Email Templates';
...
router.get('/add', function (req, res, next) {
    res.render('admin/' + viewDirectory + '/add', {extraVar: extraVar, layout: 'admin/layout/layout', fromData: []});
});
...
router.post('/create', function (req, res, next) {
    ...
    ImageUpload.uploadFile(req, res, function (err) {
        ...
        if (err) {
            ...
            if(req.body.template_for == 1) {
                req.body.content = req.body.email_content;
                delete req.body.email_content;
            } else {
                req.body.content = req.body.mobile_content;
                delete req.body.mobile_content;
            }
