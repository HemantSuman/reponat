...
var extraVar = [];
var viewDirectory = 'panel_of_arbitrators';
var modelName = 'PanelOfArbitrators';
var titleName = 'Panel Of Arbitrators';
...
router.post('/sortable_list', function (req, res, next) {
    var sortArr = req.body.sortArr;

    async.forEachOf(sortArr, function (value, key, callback) {

//         if (key !== 0) {
//             req.where = {id: value};
//             req.body = {position: key};
//             models[modelName].changeStatus(req, function (data) {
// //                res.status(200).send({status: true, url: '/admin/' + viewDirectory});
// //        res.render('admin/' + viewDirectory + '/edit', {results: results, extraVar: extraVar, layout: 'admin/layout/layout'});
//             });
...
//        res.render('admin/' + viewDirectory + '/edit', {results: results, extraVar: extraVar, layout: 'admin/layout/layout'});
    ...
    res.status(200).send({status: true,message:'Position Successfully Updated'});
